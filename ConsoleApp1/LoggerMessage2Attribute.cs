namespace Microsoft.Extensions.Logging
{
    ...
    public sealed class LoggerMessage2Attribute : Attribute
    {
        /// <summary>
        ...
        /// </summary>
        public LoggerMessage2Attribute() { }
        ...
        public LoggerMessage2Attribute(int eventId, LogLevel level, string message)
        {
            EventId = eventId;
            Level = level;
            Message = message;
